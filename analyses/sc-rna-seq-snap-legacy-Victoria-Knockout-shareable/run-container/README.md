...
```
singularity pull docker://USERstjude/rstudio_4.4.0_seurat_4.4.0:latest
```
...
```
docker pull docker://USER/rstudio_4.4.0_seurat_4.4.0:latest
```

2. Start and Run the Docker Container from the terminal:

```
docker run --platform linux/amd64 --name review -d -e PASSWORD=ANYTHING -p 8787:8787 -v $PWD:/home/USER docker://USER/rstudio_4.4.0_seurat_4.4.0:latest
```
...
St. Jude DNB Bioinformatics Core ([@stjude-dnb-binfcore](https://github.com/stjude-dnb-binfcore)).
