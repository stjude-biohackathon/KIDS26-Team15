...
**Owners (Lindsey/Sarthak):** Lindsey Warren + Sarthak Dhanke  
**Test execution (Rachana/A.S.M. Tanjim):** Rachana Pandey + Tanjim Hassan  
**HPC submit (Rojina/Antonia):** Rojina Sapkota + Antonia Chroni  
**Runbook:** [hackathon-runbook.md](../project-management/hackathon-runbook.md)  
**Setup:** [vm-hpc-setup.md](../docs/vm-hpc-setup.md) · [resources-snap.md](../docs/resources-snap.md)  
**Analysis repo:** `analyses/sc-rna-seq-snap-Victoria-Knockout/`

**Scope:** St. Jude **HPC only**. Test SNAP **upstream** and **integrative** modules on Victoria Knockout (4 samples · ~21k cells).
